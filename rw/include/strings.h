...
// AUTO-GENERATED FILE! DO NOT MODIFY BY HAND (please)!
...
extern char str_pct_d[]; // "%d"
extern char str_pct_s_pct_s[]; // "%s%s"
...
extern char str_real_war_v9_dot_25[]; // "Real War: V9.25"
extern char str_SoundSystemNotInitialized[]; // "Sound System Not Initialized"
...
extern char str_Start[]; // "Start"
extern char str_vidtree_2[]; // "VidTree"
extern char str_datatree_2[]; // "DataTree"
extern char str_pct_s_data_slash[]; // "%sdata\"
extern char str_dirtree_3[]; // "DirTree"
extern char str_space_tab[]; // " \t"
extern char str_Message_dotdotdot[]; // "Message..."
extern char str_Failed_Creating_D3D_Devices[]; // "Failed Creating D3D Devices..\n"
extern char str_Failed_on_Back_Buffer[]; // "Failed on Back Buffer\n"
extern char str_Failed_on_Front_Buffer[]; // "Failed on Front Buffer\n"
extern char str_Failed_Set_Display[]; // "Failed Set Display\n"
extern char str_Failed_Create_D3D_render[]; // "Failed Create D3D render.\n"
extern char str_Failed_Set_Coop[]; // "Failed Set Coop\n"
extern char str_Failed_On_D_Draw_Create_Query[]; // "Failed on D Draw Create Query\n"
extern char str_Failed_on_D_Draw_Create_Primary[]; // "Failed on D Draw Create Primary\n"
extern char str_Windows_Blit[]; // "Windows Blit"
extern char str_Blit_Tick_Counts_eq_Blits_Per_S[]; // "Blit Tick Counts = %d Blits Per Second"
