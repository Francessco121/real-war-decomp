...
extern bool is_sound_playing(int32 idx);
/**
...
extern void sound_func_004d2ca0(const char *path, bool dontStream, int32 idx);
extern void sound_func_004d30e0(const char *path, bool dontStream, int32 idx);
extern void sound_func_004d39a0(const uint8 *kvagBytes, int32 idx, int32 volume1, int32 volume2, int32 pitch, bool playLooping);
